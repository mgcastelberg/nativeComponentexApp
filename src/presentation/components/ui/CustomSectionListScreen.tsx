import { SectionList, SectionListComponent, Text, useWindowDimensions } from 'react-native';
        ...
        <CustomView margin>
            ...
            <Card>
                <SectionList 
                    ...
                    renderSectionHeader={ ({section}) => <SubTitle text={ section.title } safe backgroundColor={ colors.cardBackground } /> }
